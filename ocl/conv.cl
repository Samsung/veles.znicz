...
void feed_layer(__global c_dtype /*IN*/ *h, __global c_dtype /*IN*/ *weights,
  ...
  #define ROW_IN_KERNEL (OFFS_IN_KERNEL / (N_CHANNELS * KX))
  #define COL_IN_KERNEL (OFFS_IN_KERNEL % (N_CHANNELS * KX))
  ...
  #define ROW_IN_SAMPLE (KERNEL_APPLY_IN_SAMPLE / KERNEL_APPLIES_PER_WIDTH)
  #define COL_IN_SAMPLE ((KERNEL_APPLY_IN_SAMPLE % KERNEL_APPLIES_PER_WIDTH) * N_CHANNELS)

  #define SAMPLE_ROW (ROW_IN_SAMPLE + ROW_IN_KERNEL - PAD_TOP)
  #define SAMPLE_COL (COL_IN_SAMPLE + COL_IN_KERNEL - PAD_LEFT * N_CHANNELS)
