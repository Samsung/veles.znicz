        ...
        'data0':
            {
                ...
                'clone':{'use clone_const':1,'clone_const':1,'clones_proc:':[0.1,0.2]},
                'use_weight':0,
                'weight':{'weight_const':1,'use_file_weight':1,'type_model_weight':1,'weight_name_file':'xor/xor_weight_sample.csv', 'use_weight_koef_const':1,'weight_koef_const':1,'weight_koef:':[1.5,0.5]}
            }
    }
}
