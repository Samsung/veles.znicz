...
from veles.znicz.loader.base import CLASS_NAME, Loader
from veles.znicz.loader.image import FullBatchImageLoader, IImageLoader, \
    COLOR_CHANNELS_MAP
from veles.znicz.loader.fullbatch import FullBatchLoader, IFullBatchLoader
