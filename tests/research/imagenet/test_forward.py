...
class TestForward1(unittest.TestCase):
    ...
    def test_intersects(self):
        self.assertTrue(self.loader.intersects(
            (0, 0), numpy.array([[-100, -100], [100, -100],
                                 [100, 100], [-100, 100]])))
        self.assertFalse(self.loader.intersects(
    ...
    def test_inside(self):
        self.assertTrue(self.loader.inside(
            (0, 0), numpy.array([[-100, -100], [100, -100],
                                 [100, 100], [-100, 100]])))
        self.assertFalse(self.loader.inside(
    ...
    def test_intersection_area(self):
        ...
        area = self.loader.calculate_approximate_area_of_intersection(
    ...
    def test_calculate_number_of_variants(self):
        nvars = self.loader.calculate_number_of_variants(
