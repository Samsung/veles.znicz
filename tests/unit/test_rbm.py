...
class TestRBMUnits(unittest.TestCase):
    ...
    def test_GradientDescentRBM(self):
        ...
        gd_unit.output.initialize(gd_unit, False)
        ...
        gd_unit.input.initialize(gd_unit, False)
        ...
        gd_unit.bias.initialize(gd_unit, False)
        ...
        gd_unit.vbias.initialize(gd_unit, False)
        ...
        gd_unit.weights.initialize(gd_unit, False)
    ...
    def test_EvaluatorRBM(self):
        ...
        evaluator.input.initialize(evaluator, False)

        evaluator.output = Vector()
        evaluator.output.reset()
        evaluator.output.mem = numpy.zeros((128, 196),
                                           dtype=numpy.float64)
        evaluator.output.initialize(evaluator, False)
        ...
        evaluator.ground_truth.initialize(evaluator, False)
        ...
        evaluator.bias.initialize(evaluator, False)
        ...
        evaluator.vbias.initialize(evaluator, False)
        ...
        evaluator.weights.initialize(evaluator, False)
        ...
        evaluator.initialize(device=None)
        evaluator.run()
    ...
    def test_All2AllRBM(self):
        ...
        a2a.input.initialize(a2a, False)
        a2a.batch_size = 128
